...
import com.liuyanggang.microdream.entity.LygResponse;
import com.liuyanggang.microdream.entity.SimpleResponse;
import com.liuyanggang.microdream.utils.Convert;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != SimpleResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                LygResponse lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();

                //noinspection unchecked
                return (T) lzyResponse.toString();
            } else {
                // 泛型格式如下： new JsonCallback<LzyResponse<内层JavaBean>>(this)
                SimpleResponse simpleResponse = Convert.fromJson(jsonReader, SimpleResponse.class);
                response.close();
                int code = simpleResponse.status;
                //这里的0是以下意思
