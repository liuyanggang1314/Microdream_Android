 ...
 * @Version 1.0
 */
public class UnauthorizedDialog extends QMUIDialog {
    ...
    public UnauthorizedDialog(Context context, int styleRes) {
    ...
    private void initView() {
        ...
        info.setText(getContext().getString(R.string.login_timeout));
        back.setVisibility(View.INVISIBLE);
        dialogTitile.setText(getContext().getString(R.string.remind));
    }
    ...
    public UnauthorizedDialog setOnClickCloseListener(OnClickCloseListener onClickCloseListener) {
