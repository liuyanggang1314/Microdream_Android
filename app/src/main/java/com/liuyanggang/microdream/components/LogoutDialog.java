 ...
 * @Version 1.0
 */
public class LogoutDialog extends QMUIDialog {
    ...
    public LogoutDialog(Context context, int styleRes) {
    ...
    public LogoutDialog setOnClickCloseListener(OnClickCloseListener onClickCloseListener) {
